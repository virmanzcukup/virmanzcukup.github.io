        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                <div class='wa-chat-box-header'>
                    <img width="50" style="padding-left: 10px" onError='this.src= "img/cs.svg";' src='${option.brandSetting.brandImg}'/>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'> <a>CS satkom net</a></div>
                </div>
            </div>
        `);
